...
@WebServlet(urlPatterns = {"/list-product", "/add-cart", "/supplier"})
public class ProductController extends HttpServlet{
	...
	//View cart tại header
		...
		public void getProduct_Supplier(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException, ParseException {
			String cID = req.getParameter("supplier-id");
			...
			int page = Integer.parseInt(indexPage);
				...
				if (cID == null) {
					...
					//Láy ds sản phẩm theo category
					List<Product> arrProduct = new ProductDao().getAllProductbySupplier(page, cID);
