			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-12">
						...
						<div class="card">
							<div class="card-body">
								<h5 class="card-title">Danh sách nhà sản xuất</h5>
								<h6 style="color: red">
								...
								<button style="margin-bottom: 10px" data-toggle="modal"
									data-target="#myModal">Thêm nhà sản xuất</button>
											...
											<c:forEach items="${listSupplier }" var="o">
												<tr>
													...
													<td><a
														...
														href="delete-supplier?sid=${o.id }"></a>
					...
					<div class="modal-dialog">
						...
						<div class="modal-content">
							...
							<div class="modal-body">
								<form class="w3-container" action="add-supplier">

									<p>
										<label>ID Nhà sản xuất</label> <input class="w3-input"
											type="text" name="sid">
									</p>
									<p>
										<label>Tên nhà sản xuất</label> <input class="w3-input"
				...
				<div class="modal fade" id="myModal1" role="dialog">
					<div class="modal-dialog">
						...
						<div class="modal-content">
							<div class="modal-header">
									<h4 class="w3-text-blue">Input Form</h4>
								<button type="button" class="close" data-dismiss="modal">&times;</button>

							</div>
							<div class="modal-body">
								<form class="w3-container w3-card-3" action="/action_page.php">
									<p>
										<label class="w3-text-blue"><b>First Name</b></label> <input
											class="w3-input w3-border" name="first" type="text">
									</p>
									<p>
										<label class="w3-text-blue"><b>Last Name</b></label> <input
