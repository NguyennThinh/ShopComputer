	...
	<div class="container">
		...
		<div class="row margin-bottom-40">
			...
			<div class="col-md-12 col-sm-12">
				<h1>Shopping cart</h1><h3 style="color: red">${error }</h3>
							...
							<div class="table-wrapper-responsive">
								...
								<table summary="Shopping cart">
									...
									<c:forEach items="${listCart}" var="c">
										<tr>
											<td><input type="checkbox" name="idDetail"
												value="${c.id_Detail }"></td>
											<td class="goods-page-image"><a href="javascript:;"><img
													src="${c.photo }" alt="Berry Lace Dress"></a></td>
											...
											<td class="goods-page-ref-no">${c.sale }%</td>
											<td class="goods-page-quantity">
												<div class="product-quantity">
													<input id="product-quantity" type="text"
														value="${c.quantily }" readonly
														class="form-control input-sm">
												</div>
											</td>
											<td class="goods-page-price"><strong>${c.price }<span>VND</span></strong>
											</td>
											<td class="goods-page-total"><strong>${c.total }<span>VND</span></strong>
											</td>
											<td class="del-goods-col"><a class="del-goods"
												href="delete-cart?cid=${c.id_Detail }">&nbsp;</a></td>
										</tr>
									</c:forEach>
